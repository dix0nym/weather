...
public class Main {
   ...
   * @param humidity  - humidity of air
  ...
  public String toString() {
    return new ToStringBuilder(this).append("temp", temp).append("feelsLike", feelsLike)
        .append("tempMin", tempMin).append("tempMax", tempMax).append("pressure", pressure)
        .append("humidity", humidity).append("additionalProperties", additionalProperties)
        .toString();
  }
